...
## 1.1 Integração com base de dados
...
2.2 Totalização correta dos preços do pedido
2.2.1 TDD - Desenvolvimento
...
X.3 Tradução para outros idiomas
X.3.1 TDD - Desenvolvimento
...
Y Integração entre antigas e novas funcionalidades
Y.1 Integração da base de dados com o sistema
...
Y.2 Integração da totalização correta dos preços do pedido
...
Y.3 Integração da Tradução com o sistema
